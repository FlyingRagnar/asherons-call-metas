Count Phainor Fellow V1  
Completes Count Phainor's Amulet quest (aka Graverobber)  as a multi-client fellowship       
Level 180+  
...
- Type the following in chat: /ub bc /vt meta load CountPhainorFellowV1
...
- When navigating from the Graveyard recall bunker to the dungeon, the meta will retry if it gets stuck for too long
